...
def test_no_demo_environment_is_seeded(client):
    """The app never seeds a local demo environment; it only ever connects to a
    real Oracle EPM tenant the user supplies."""
